...
from task_20_3 import send_command_to_devices
            ...
            for key,value in commands.items():
                if ip == key:
                    for command in value:
                        ...
                        future = executor.submit(send_command_to_devices, device, comm, 'out_3a.txt')
