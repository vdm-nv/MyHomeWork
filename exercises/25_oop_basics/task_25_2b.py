...
class CiscoTelnet:
    ...
    def send_config_commands(self, commands):
        ...
        time.sleep(0.5)
        out_res = self.telnet.read_very_eager().decode('ascii')
        pprint(out_res)
        return out_res
...
if __name__ == '__main__':
    ...
    print('#'*79)
    print('Использование метода send_config_commands:')
    print("команда - r1.send_config_commands('logging 10.1.1.1')") 
    r1.send_config_commands('logging 10.1.1.1')
    print('#'*79)
    print("команда -r1.send_config_commands(['interface loop55', 'ip address 5.5.5.5 255.255.255.255'])")
